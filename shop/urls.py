...
from shop.views import ShopUpdateView, ShopProductListView, ShopOverviewView, ShopOrderListView, ShopProductUpdateView, ShopProductCreateView, ShopOrderDetailView
